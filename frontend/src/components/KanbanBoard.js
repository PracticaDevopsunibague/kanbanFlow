...
const KanbanBoard = ({ projectId }) => {
  ...
  const columns = {
    pending: { title: 'Pendiente', color: 'bg-yellow-100 border-yellow-300' },
    in_progress: { title: 'En Progreso', color: 'bg-blue-100 border-blue-300' },
    completed: { title: 'Completado', color: 'bg-green-100 border-green-300' }
  };
